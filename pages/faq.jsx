                ...
                >
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("When and where answare 1")}</li>
                                <li>{t("When and where answare 2")}</li>
                                <li>
                    ...
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("Who trains here answare")}</li>
                            </ul>
                        </Accordion.Content>
                    </Accordion.Panel>
                    <Accordion.Panel>
                    ...
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("Compete to join answare")}</li>
                            </ul>
                        </Accordion.Content>
                    </Accordion.Panel>
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("Leaders answare 1")}</li>
                                <li>{t("Leaders answare 2")}</li>
                            </ul>
                        </Accordion.Content>
                    </Accordion.Panel>
                    <Accordion.Panel>
                    ...
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("Training clothes answare 1")}</li>
                                <li>{t("Training clothes answare 2")}</li>
                                <li>{t("Training clothes answare 3")}</li>
                                <li>{t("Training clothes answare 4")}</li>
                            </ul>
                        </Accordion.Content>
                    </Accordion.Panel>
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("Cost answare 1")}</li>
                                <li>{t("Cost answare 2")}</li>
                            </ul>
                        </Accordion.Content>
                    </Accordion.Panel>
                    <Accordion.Panel>
                    ...
                    <Accordion.Panel>
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>{t("Rules answare 1")}</li>
                                <li>{t("Rules answare 2")}</li>
                                <li>{t("Rules answare 3")}</li>
                                <li>{t("Rules answare 4")}</li>
                                <li>{t("Rules answare 5")}</li>
                                <li>{t("Rules answare 6")}</li>
                                <li>
                                    {t("Rules answare 7")} &nbsp;
                                    <Link
                                        className='underline hover:text-ba-color-gold'
                        ...
                        <Accordion.Content className='listing'>
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li>{t("Technique answare 2")}</li>
                                        <li>{t("Technique answare 3")}</li>
                                        <li>{t("Technique answare 4")}</li>
                                    </ul>
                                </li>
                            </ul>
                        </Accordion.Content>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            {/* (link til lisensinfo) */}
                                            {t(
                                                "Compete what I need answare 4.5"
                                            )}
                                        </li>
                                        <li>
                                            ...
                                            {t(
                                                "Compete what I need answare 5.5"
                                            )}
                                        </li>
                                    </ul>
                                </li>
                                <li>{t("Compete what I need answare 6")}</li>
                                <li>{t("Compete what I need answare 7")}</li>
                            </ul>
                        </Accordion.Content>
                    </Accordion.Panel>
                    <Accordion.Panel>
