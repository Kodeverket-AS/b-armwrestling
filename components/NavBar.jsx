            ...
            <ul className="relative items-center justify-center space-y-8 text-center md:flex md:space-x-6 md:space-y-0">
              ...
              <ul
                className=" hidden peer-hover:flex hover:flex 
                                  w-[200px]
                                  flex-col drop-shadow-lg absolute bg-zinc-900 top-14 pt-7 z-10  "
              >
              ...
              <Link href="/bli-medlem">
                <button className="z-20 px-4 py-3 mt-6 text-center text-white transition duration-500 ease-in-out transform border-2 lg:w-full w-36 border-ba-color-gold rounded-xl hover:bg-ba-color-gold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 md:mt-0">
                  Meld Deg Inn
                </button>
              </Link>
            </ul>
